...
PATH=$PATH:/usr/local/bin:$HOME/src/nix/result/bin:$HOME/bin:$HOME/src/go/bin/:$HOME/.cabal/bin:$HOME/.local/bin:$HOME/bin:/opt/texlive/2017/bin/x86_64-linux/:/sbin:/home/poq/src/pkg/wmrc
#WM="windowchef"
BROWSER="firefox"
