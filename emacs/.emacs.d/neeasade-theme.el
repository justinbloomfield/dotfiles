;;; neeasade-theme.el --- A port of the default xst colours to an emacs theme
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (red "#cf6a4c") ;; tab-control-hover-tab-close-button
       (orange "#9b859d") ;; darker tab-control-dirty-tab-close-butto
       (yellow "#f9ee98") ;; tab-control-dirty-tab-close-button
       (green "#8f9d6a") ;; complement tab-control-dirty-tab-close-button
       (aqua "#afc4db") ;; lighter complement tab-control-dirty-tab-close-button
       (blue "#7567a6") ;; complement tab-control-dirty-tab-close-button
       (purple "#a7a7a7")) ;; complement tab-control-dirty-tab-close-button
