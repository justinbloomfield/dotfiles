...
PATH=$PATH:/usr/local/bin:$HOME/src/nix/result/bin:$HOME/bin:$HOME/src/go/bin/:$HOME/.cabal/bin:$HOME/.local/bin:$HOME/bin:/opt/texlive/2017/bin/x86_64-linux/
#WM="windowchef"
BROWSER="firefox"
...
export CSC EDITOR PAGER NTFY_FIFO_PATH LC_CTYPE PATH CHOME WM WP_DIR GOPATH TERM GTK_IM_MODULE XMODIFIERS QT_IM_MODULE MAIL PS1 SSH_ASKPASS JAVA_HOME
