...
(custom-theme-set-faces
 ...
 '(cursor ((t (:background "#00ff7f" :foreground "#000000" :underline nil :weight normal))))
 ...
 '(region ((t (:weight normal :underline nil :background "#00ff7f" :foreground "#000"))))
 ...
 '(font-lock-comment-face ((t (:foreground "#7f00ff" :underline nil :weight normal))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#ff007f" :underline nil :weight normal))))
 '(font-lock-keyword-face ((t (:foreground "#007fff" :underline nil :weight normal))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#00ff7f" :underline nil :weight normal))))
 ...
 '(mode-line-inactive ((t (:weight normal :underline nil :box nil :foreground "#4a4b4c" :background "#101010" :inherit (mode-line)))))
 ...
 '(mu4e-highlight-face ((t (:background "#000" :foreground "#00ff7f"))))
 '(mu4e-header-key-face ((t (:foreground "#00ff7f"))))
 '(mu4e-title-face ((t (:foreground "#ff007f"))))

 '(circe-server-face ((t (:foreground "#007fff"))))
 '(lui-time-stamp-face ((t (:foreground "#7f00ff"))))
